...
ppmdiff: ppmdiff.o a2plain.o a2blocked.o uarray2b.o uarray2.o 
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)

40image-6: 40image.o compress40.o componentIMG.o quantizedIMG.o \
compressedIMG.o a2plain.o a2blocked.o uarray2b.o uarray2.o bitpack.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
